...
export const CategoriesFeatureBanner: React.FC = () => {
  return (
    <section className="mt-10 sm:mt-14 md:mt-16 px-4 sm:px-8 md:px-16 py-10 sm:py-14 md:py-16 bg-[#f3f3f3] max-w-[1440px] mx-auto flex flex-col md:grid md:grid-cols-2 items-center gap-8 font-sans">
      {/* 1. Image panel first on mobile */}
      <div className="relative h-[280px] sm:h-[380px] md:h-[480px] w-full overflow-hidden">
        <img
